...
class Subscription(Base):
    ...
    media_type: Mapped[str] = mapped_column(String(10), nullable=False, comment="媒体类型: movie / tv")
    title: Mapped[str] = mapped_column(String(500), nullable=False, comment="媒体标题")
    poster_url: Mapped[str | None] = mapped_column(Text, nullable=True, comment="海报 URL")
    year: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="发行年份")
    nf_subscribed: Mapped[bool] = mapped_column(Boolean, default=False, comment="是否已添加到 NextFind")
